      ...
      >
        <div className="flex-1 space-y-6 min-w-0 w-full">
          ...
          <p className="text-md text-muted-foreground leading-relaxed">
            ...
            Management serta Graphic Design. Saya selalu berusaha untuk terus
        ...
        <motion.div variants={FADE_IN} className="relative group shrink-0">
          <div className="relative w-64 h-72 md:w-80 md:h-85 overflow-hidden shadow-xl rounded-sm">
            <PixelTransition
              ...
              secondContent={
                <div className="w-full h-full flex flex-col items-center justify-center bg-zinc-900 text-center p-4 rounded-sm">

...
const StrokeText = ({
  ...
  }, [characters, fontSize, fontWeight, letterSpacing, strokeWidth, numericFontSize]);
  ...
  return (
    <span
      ...
      style={{ ...style, '--stroke-text-height': `${Math.round(numericFontSize * 1.3)}px` } as React.CSSProperties}
      role="img"
